...
#SBATCH --job-name="detectability_TSLL_SP_1e3"
...
python -u /projects/prjs2180/code/hcc-dualphase-segmentation/scripts/evaluation/detectability.py \
    --pred_dir /projects/prjs2180/data/nnUNet_results/TSLL_SP_1e3/Dataset001_singlephase/nnUNetTrainer__TSLL_SP_plans__3d_fullres/fold_0/validation \
    --gt_dir /projects/prjs2180/data/nnUNet_raw/Dataset001_singlephase/labelsTr \
    --thresholds 0.15 0.2 0.5 \
    --output /projects/prjs2180/evaluation/detectability/detectability_TSLL_SP_1e3.csv
