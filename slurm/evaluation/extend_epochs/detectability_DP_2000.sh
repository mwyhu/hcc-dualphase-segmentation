...
#SBATCH --job-name=detectability_DP_2000_epochs
...
PRED_DIR="/projects/prjs2180/data/nnUNet_results/extend_epochs/DP_poly_1e3_2000epochs/Dataset002_dualphase/nnUNetTrainer__TSLL_DP_plans__3d_fullres/fold_0/validation"
