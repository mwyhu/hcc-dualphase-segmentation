...
#SBATCH --job-name="apply_liver_mask_1000ep"
...
python /projects/prjs2180/code/hcc-dualphase-segmentation/scripts/postprocessing/apply_liver_mask.py \
    --prediction_dir /projects/prjs2180/data/nnUNet_results/TSLL_DP_1e3/Dataset002_dualphase/nnUNetTrainer__TSLL_DP_plans__3d_fullres/fold_0/validation \
    --liver_dir /projects/prjs2180/liver_masks \
    --output_dir /projects/prjs2180/postprocessed/validation/DP_1000ep
